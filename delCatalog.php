        ...
        <div class="card">
            ...
            <div class="mb-3">
                        ...
                        <div class="card-body">
                            <table class="table">
                                <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        $sql2   = "select * from barang where id_stuff = '$ID'";
                                        $q2     = mysqli_query($koneksi, $sql2);
                                        $urut   = 1;
                ...
                <form action="" method="POST">
                                ...
                                <div class="col-12">
                                    <a href="delCatalog.php?op=delete&id=<?php echo $ID ?>">
                            <button type="submit" name="submit" value="Simpan Data" class="btn btn-danger"> Hapus Data </button>
                        </a>     
                                </div>
